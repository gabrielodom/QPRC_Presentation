...
- Decentralized wastewater treatment (WWT) plant in Golden, CO
- We aim to quickly and accurately detect when a part of the cleaning process malfunctions.

## Competing Methods

## Current Perspectives
- Earlier work applying PCA to WWT by @wise_principal_1988 and @kresta_multivariate_1991
- More recent work applying PCA by @baggiani_real-time_2009, @sanchez-fernandez_fault_2015, and @kazor_comparison_2016
