...
### Hotelling's $T^2$
- Let $\boldsymbol\Lambda_d := \text{diag}\left( \lambda_1, \lambda_2, \ldots, \lambda_d \right)$ be the largest $d$ eigenvalues associated with the first $d$ eigenvectors in $\mathbb{P}_d$.
- The Hotelling's $T^2$ statistic is $T^2_{s + 1} = \textbf{Y}_{s + 1}\boldsymbol\Lambda_d^{-1} \textbf{Y}_{s + 1}^T$.
